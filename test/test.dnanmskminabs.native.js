...
var dnanmskminabs = tryRequire( resolve( __dirname, './../lib/dnanmskminabs.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dnanmskminabs.length, 5, 'has expected arity' );
	t.end();
});
...
tape( 'the function calculates the minimum absolute value of a strided array according to a mask, ignoring NaN values', opts, function test( t ) {
	...
	v = dnanmskminabs( x.length, x, 1, mask, 1 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN`', opts, function test( t ) {
	...
	v = dnanmskminabs( 0, x, 1, mask, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );

	v = dnanmskminabs( -1, x, 1, mask, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );
...
tape( 'the function supports view offsets', opts, function test( t ) {
	...
	v = dnanmskminabs( 6, x1, 2, mask1, 2 );
	t.strictEqual( v, 1.0, 'returns expected value' );
