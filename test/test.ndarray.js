...
var dnanmskminabs = require( './../lib/ndarray.js' );
...
tape( 'the function calculates the minimum absolute value of a strided array according to a mask, ignoring NaN values', function test( t ) {
	var mask;
	var x;
	var v;
